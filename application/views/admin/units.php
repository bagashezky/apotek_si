        ...
        <table class="table table-bordered table-hover " id="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $u->name ?></a></td>
            <td>
              <a href="#" class="badge badge-primary" data-toggle="modal" data-target="#editunit"
              data-id-unit="<?= $u->id ?>"
              data-unit-name="<?= $u->name ?>">Ubah</a>
              &nbsp;
              <a href="<?= base_url("admin/deleteunit/". $u->id) ?>" onclick="return confirm('Lanjutkan menghapus data?')" class="badge badge-danger">Hapus</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
